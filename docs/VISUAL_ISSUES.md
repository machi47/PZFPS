...
| V-04 | Interior furniture/fixtures leak through exterior walls | 11, 22 | **Partial, rejected live**. Canonical finite-wall clipping exists and sealed-wall edge coverage is now depth-bearing, but ownership and multi-tile cases are incomplete. | Exterior orbit of the fixture set shows zero interior pixels except through intentional openings. |
