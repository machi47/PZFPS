...
| V-03 | Building shells have cracks, curved-looking joins, missing corners and gaps at wall/ground/ceiling boundaries | 04, 10, 34 | **Partial, rejected live**. Captured opaque wall edges now receive a sealed-only alpha/depth join; real-source and GPU checks pass, but generic edge cards do not yet form a watertight building shell. | Multi-room fixture is watertight from inside and outside at every corner, doorway, storey and floor junction. |
| V-04 | Interior furniture/fixtures leak through exterior walls | 11, 22 | **Partial, rejected live**. Canonical finite-wall clipping exists, sealed-wall edge coverage is depth-bearing, and clipping now crosses all four neighboring chunk boundaries with mesh invalidation. Broader ownership and multi-tile cases remain incomplete. | Exterior orbit of the fixture set shows zero interior pixels except through intentional openings. |
...
| V-16 | First-person player body is absent or incomplete | Reported verbally after 32 and again 2026-09-23 | **Partial, unaccepted**. The current pass submits PZ's root body and clothing models and masks the head in a copied render palette; callback counters do not prove visible pixels, and the owner still reports no usable first-person body. | Looking down and moving/attacking shows correctly posed body, clothing, hands and held item without face-inside-camera artifacts. |
...
| V-18 | PZ-native vehicles are half-visible or absent in the first-person scene | Reported verbally 2026-09-23 | **Source-level correction built and staged, not live-accepted**. The vehicle slot angle was passed through as `NaN`, normal paint/light refresh was skipped, and the perspective pass inherited isometric alpha; corrections now preserve PZ's evaluated vehicle transform/state while using perspective visibility. | Inspect parked, moving and damaged vehicles from several headings; confirm complete native body, wheels, textures/damage, and real depth occlusion. |
